...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_itinerary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('main', ['Itinerary'])

        # Adding M2M table for field users on 'Itinerary'
        db.create_table('main_itinerary_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('itinerary', models.ForeignKey(orm['main.itinerary'], null=False)),
            ('userprofile', models.ForeignKey(orm['main.userprofile'], null=False))
        ))
        db.create_unique('main_itinerary_users', ['itinerary_id', 'userprofile_id'])

        # Adding model 'Location'
        db.create_table('main_location', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('itinerary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Itinerary'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.create_table('main_activity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('itinerary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Location'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('main_itinerary')

        # Removing M2M table for field users on 'Itinerary'
        db.delete_table('main_itinerary_users')
    ...
    models = {
        ...
        'main.activity': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'itinerary': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Location']"}),
        ...
        'main.itinerary': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['main.UserProfile']", 'symmetrical': 'False'})
        },
        'main.location': {
            'Meta': {'object_name': 'Location'},
            'end_time': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'itinerary': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Itinerary']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'start_time': ('django.db.models.fields.DateTimeField', [], {})
        },
        'main.userprofile': {
