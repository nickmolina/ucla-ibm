from main.models import UserProfile, Itinerary, Location
...
# fill activity table
l1.activity_set.create(name="hollywood blvd", start_time="2012-01-01", end_time="2012-01-02")
l1.activity_set.create(name="westwood LA", start_time="2012-01-02", end_time="2012-01-03")
l2.activity_set.create(name="sf bay", start_time="2012-01-15", end_time="2012-01-16")
